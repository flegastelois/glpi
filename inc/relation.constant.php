...
$RELATION = [
   ...
   'glpi_businesscriticities'
      => ['glpi_businesscriticities'=> 'businesscriticities_id',
   ...
   'glpi_computers'
      => ['glpi_computerantiviruses'       => 'computers_id',
   ...
   'glpi_crontasks'
      => ['glpi_crontasklogs'=> 'crontasks_id'],
   'glpi_datacenters'
   ...
   'glpi_enclosures'
      => ['glpi_items_enclosures'=> 'enclosures_id'],
   'glpi_entities'
      => ['glpi_apiclients'                => 'entities_id',
          ...
          'glpi_cartridges'                => 'entities_id',
          'glpi_certificates'              => 'entities_id',
          'glpi_certificatetypes'          => 'entities_id',
          'glpi_changecosts'               => 'entities_id',
          'glpi_changes'                   => 'entities_id',
          'glpi_changevalidations'         => 'entities_id',
          'glpi_computers'                 => 'entities_id',
          'glpi_computers_softwareversions'=> 'entities_id',
          'glpi_computervirtualmachines'   => 'entities_id',
          'glpi_consumableitems'           => 'entities_id',
          'glpi_consumables'               => 'entities_id',
          'glpi_contacts'                  => 'entities_id',
          'glpi_contractcosts'             => 'entities_id',
          ...
          'glpi_items_devicebatteries'     => 'entities_id',
          'glpi_items_devicecases'         => 'entities_id',
          'glpi_items_devicecontrols'      => 'entities_id',
          'glpi_items_devicedrives'        => 'entities_id',
          'glpi_items_devicefirmwares'     => 'entities_id',
          'glpi_items_devicegenerics'      => 'entities_id',
          'glpi_items_devicegraphiccards'  => 'entities_id',
          'glpi_items_deviceharddrives'    => 'entities_id',
          'glpi_items_devicememories'      => 'entities_id',
          'glpi_items_devicemotherboards'  => 'entities_id',
          'glpi_items_devicenetworkcards'  => 'entities_id',
          'glpi_items_devicepcis'          => 'entities_id',
          'glpi_items_devicepowersupplies' => 'entities_id',
          'glpi_items_deviceprocessors'    => 'entities_id',
          'glpi_items_devicesensors'       => 'entities_id',
          'glpi_items_devicesimcards'      => 'entities_id',
          'glpi_items_devicesoundcards'    => 'entities_id',
          'glpi_items_disks'               => 'entities_id',
          'glpi_items_operatingsystems'    => 'entities_id',
          ...
          'glpi_networkports'              => 'entities_id',
          'glpi_notifications'             => 'entities_id',
          'glpi_olalevels'                 => 'entities_id',
          'glpi_olas'                      => 'entities_id',
   ...
   'glpi_groups'
      => ['glpi_cartridgeitems'      => 'groups_id_tech',
          ...
          'glpi_groups_rssfeeds'     => 'groups_id',
   ...
   'glpi_knowbaseitems'
      => ['glpi_entities_knowbaseitems'  => 'knowbaseitems_id',
          ...
          'glpi_knowbaseitems_comments'  => 'knowbaseitems_id',
          'glpi_knowbaseitems_items'     => 'knowbaseitems_id',
          'glpi_knowbaseitems_profiles'  => 'knowbaseitems_id',
          'glpi_knowbaseitems_revisions' => 'knowbaseitems_id',
   ...
   'glpi_networkportlocals'
      => [],
   'glpi_networkports'
      => ['glpi_networkportaggregates'    => ['networkports_id', 'networkports_id_list'],
          'glpi_networkportaliases'       => ['networkports_id', 'networkports_id_alias'],
   ...
   'glpi_pdus'
      => ['glpi_pdus_plugs'=> 'pdus_id',
          'glpi_pdus_racks'=> 'pdus_id'],
   'glpi_pdus_plugs'
      => [],
   'glpi_pdus_racks'
      => [],
   ...
   'glpi_profiles'
      => ['glpi_knowbaseitems_profiles'=> 'profiles_id',
          ...
          'glpi_profiles_rssfeeds'     => 'profiles_id',
   ...
   'glpi_racks'
      => ['glpi_items_racks'=> 'racks_id',
          'glpi_pdus_racks' => 'racks_id'],
   'glpi_racktypes'
   ...
   'glpi_savedsearches'
      => ['glpi_savedsearches_alerts'=> 'savedsearches_id',
   ...
   'glpi_softwarecategories'
      => ['glpi_softwarecategories'=> 'softwarecategories_id',
          'glpi_softwares'         => 'softwarecategories_id'],
   'glpi_softwarelicenses'
      => ['glpi_computers_softwarelicenses'=> 'softwarelicenses_id',
          'glpi_softwarelicenses'          => 'softwarelicenses_id'],
   'glpi_softwarelicensetypes'
      => ['glpi_softwarelicenses'    => 'softwarelicensetypes_id',
          'glpi_softwarelicensetypes'=> 'softwarelicensetypes_id'],
   'glpi_softwares'
   ...
   'glpi_softwareversions'
      => ['glpi_computers_softwareversions'=> 'softwareversions_id',
          'glpi_softwarelicenses'          => ['softwareversions_id_buy', 'softwareversions_id_use']],
   ...
   'glpi_tickets'
      => ['glpi_changes_tickets'     => 'tickets_id',
          ...
          'glpi_olalevels_tickets'   => 'tickets_id',
   ...
   'glpi_tickettemplates'
      => ['glpi_entities'                      => 'tickettemplates_id',
          'glpi_itilcategories'                => ['tickettemplates_id_incident', 'tickettemplates_id_demand'],
          'glpi_profiles'                      => 'tickettemplates_id',
          'glpi_ticketrecurrents'              => 'tickettemplates_id',
          'glpi_tickettemplatehiddenfields'    => 'tickettemplates_id',
          'glpi_tickettemplatemandatoryfields' => 'tickettemplates_id',
          'glpi_tickettemplatepredefinedfields'=> 'tickettemplates_id'],
   ...
   'glpi_users'
      => ['glpi_cartridgeitems'          => 'users_id_tech',
          ...
          'glpi_changes'                 => ['users_id_recipient', 'users_id_lastupdater'],
          'glpi_changes_users'           => 'users_id',
          'glpi_changetasks'             => ['users_id', 'users_id_editor', 'users_id_tech'],
          'glpi_changevalidations'       => ['users_id', 'users_id_validate'],
          ...
          'glpi_itilsolutions'           => ['users_id', 'users_id_editor', 'users_id_approval'],
          ...
          'glpi_notepads'                => ['users_id', 'users_id_lastupdater'],
          'glpi_notimportedemails'       => 'users_id',
          'glpi_objectlocks'             => 'users_id',
          ...
          'glpi_problems'                => ['users_id_recipient', 'users_id_lastupdater'],
          'glpi_problems_users'          => 'users_id',
          'glpi_problemtasks'            => ['users_id', 'users_id_editor', 'users_id_tech'],
          ...
          'glpi_ticketfollowups'         => ['users_id', 'users_id_editor'],
          'glpi_tickets'                 => ['users_id_lastupdater', 'users_id_recipient'],
          'glpi_tickets_users'           => 'users_id',
          'glpi_tickettasks'             => ['users_id', 'users_id_editor', 'users_id_tech'],
          'glpi_ticketvalidations'       => ['users_id', 'users_id_validate'],
   ...
   'glpi_vlans'
      => ['glpi_ipnetworks_vlans'  => 'vlans_id',
